...
class MembershipPackageService {
  final String baseUrl = 'http://192.168.1.10:5084/api/membership-packages';
  ...
  Future<void> updateMembershipPackage(MembershipPackage membershipPackage) async {
    try {
      final response = await http.put(
        Uri.parse('https://192.168.1.10:7083/api/membership-packages/${membershipPackage.membershipPackageId}'),
