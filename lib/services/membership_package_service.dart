...
class MembershipPackageService {
  final String baseUrl = 'http://172.20.10.2:5084/api/membership-packages';
  ...
  Future<void> updateMembershipPackage(MembershipPackage membershipPackage) async {
    try {
      final response = await http.put(
        Uri.parse('https://172.20.10.2:7083/api/membership-packages/${membershipPackage.membershipPackageId}'),
