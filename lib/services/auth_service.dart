...
class AuthService {
  Future<LoginResponseDto?> login(String email, String password) async {
    final url = Uri.parse('https://172.20.10.2:7083/api/auth/login');
  ...
  Future<Map<String, dynamic>?> getUserData(String userId, String jwtToken, String role) async {
    ...
    if (role == 'Client') {
      url = Uri.parse('https://172.20.10.2:7083/api/clients/$userId');
      //url = Uri.parse('https://10.0.2.2:7083/api/clients/$userId');
    } else if (role == 'Trainer') {
      url = Uri.parse('http://172.20.10.2:5084/api/trainers/$userId');
      //url = Uri.parse('http://10.0.2.2:5084/api/trainers/$userId');
    } else {
      url = Uri.parse('https://172.20.10.2:7083/api/users/$userId');
  ...
  Future<bool> signUp(User user) async {
    final url = Uri.parse('https://172.20.10.2:7083/api/auth/register');
  ...
  Future<bool> getClientsById(String jmbg) async {
    final url = Uri.parse('https://172.20.10.2:7083/api/clients/$jmbg');
  ...
  Future<List<User>> fetchTrainers() async {
    final url = Uri.parse('http://172.20.10.2:5084/api/trainers');
  ...
  Future<List<User>> fetchClients() async {
    final url = Uri.parse('https://172.20.10.2:7083/api/clients');
  ...
  Future<List<User>> searchClients(String searchTerm) async {
    final url = Uri.parse('https://172.20.10.2:7083/api/clients/search?searchTerm=$searchTerm');
  ...
  Future<void> updateClient(User user) async {
    final url = Uri.parse('https://172.20.10.2:7083/api/clients/${user.jmbg}');
  ...
  Future<void> updateTrainer(User user) async {
    final url = Uri.parse('https://172.20.10.2:7083/api/trainers/${user.jmbg}');
